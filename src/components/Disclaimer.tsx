      ...
      {open && (
        <div className="mt-2 space-y-1 border-t border-amber-900/40 pt-2 text-[11px] leading-relaxed text-amber-200/70">
          <p>
            ...
            (NSE, BSE, MoneyControl, CNBC, Google News) and are for financial literacy only. Every
            AI explanation is monitored by PRISM evaluators for groundedness, consistency and
            advice-safety.
          </p>
          <p>
